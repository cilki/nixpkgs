...
- [FUTO Notes Server](https://gitlab.futo.org/futo-notes/futo-notes-server), the self-hosted end-to-end-encrypted sync server for the FUTO Notes app. Available as [services.futo-notes-server](#opt-services.futo-notes-server.enable).
